...
export const OPEN_NEW_DOCUMENT_NOTIFICATIONS_MODAL = 'OPEN_NEW_DOCUMENT_NOTIFICATIONS_MODAL';
...
export const openNewDocumentNotificationsModal = createAction(OPEN_NEW_DOCUMENT_NOTIFICATIONS_MODAL);
