...
class CRPage extends Component {
  render() {
    const {
      ...
      openRequestDocumentModal, openNewDocumentNotificationsModal, summary, victims, startDate, endDate, popup,
      pathname, notes, noAttachmentTextEditWrapperStateProps,
    } = this.props;
