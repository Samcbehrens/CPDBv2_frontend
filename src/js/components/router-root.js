...
import ResolvingPageContainer from 'containers/resolving-page';
import {
  COLLAB_PATH, FAQ_PATH, STORIES_PATH, SEARCH_PATH, OFFICER_PATH, RESOLVING_MATCHING_PATH
...
class RouterRoot extends Component {
  ...
  render() {
    const routes = [
      ...
      <Route path={ RESOLVING_MATCHING_PATH } component={ ResolvingPageContainer } key='6'/>
    ];
