...
describe('SearchPage component', function () {
  ...
  describe('after keyboard navigation', function () {
    ...
    it ('should scroll to focused item', function () {
      ...
      ReactDOM.render(<SearchPage focusedItem={ { uniqueKey: 'OFFICER-1234' } }
        pushBreadcrumbs={ this.stubPushBreadcrumbs } />, domNode);
      ReactDOM.render(<SearchPage focusedItem={ { uniqueKey: 'OFFICER-5678' } }
        pushBreadcrumbs={ this.stubPushBreadcrumbs }/>, domNode);
